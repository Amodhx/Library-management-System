...
public class BorrowingDetailsService {
    ...
    public boolean saveBorrowingDetails(BorrowingDetailDTO borrowingDetailDTO){
        ...
        return borrowingDAO.saveBorrowingDetail(new BorrowingDetails(borrowingDetailDTO.getId(),borrowingDetailDTO.getBorrowingDate(),borrowingDetailDTO.getDueDate(),userById,bookUsingID));
    }
}
